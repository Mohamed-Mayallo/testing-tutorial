// Global set up for integration testing
...
beforeAll(async () => {
  jest.setTimeout(50000); // Increase Jest timeout in case of integration testing
...
// Exports the testing app as a function to be fully initialized
